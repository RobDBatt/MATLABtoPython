...
export const IMPORT_STATEMENTS: Record<string, string> = {
  ...
  'scipy.spatial': 'from scipy import spatial',
  'scipy.cluster': 'from scipy import cluster',
  'scipy.fft': 'from scipy import fft as sfft',
  'scipy.spatial.transform': 'from scipy.spatial.transform import Rotation',
  'skimage.exposure': 'from skimage import exposure',
  'skimage.filters': 'from skimage import filters',
